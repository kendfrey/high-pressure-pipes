...
highPressurePipe.icons = {{icon = data.raw.item["pipe"].icon, tint = highPressureTint}};
...
highPressurePipeToGround.icons = {{icon = data.raw.item["pipe-to-ground"].icon, tint = highPressureTint}};
...
highPressurePump.icons = {{icon = data.raw.item["pump"].icon, tint = highPressureTint}};
